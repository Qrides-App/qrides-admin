            ...
            function fetchDocuments() {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        const labelMap = {
                            "driving_licence_front_status": "Driving Licence – Front",
                            "driving_licence_back_status": "Driving Licence – Back",
                            "aadhaar_front_status": "Aadhaar – Front",
                            "aadhaar_back_status": "Aadhaar – Back",
                            "pan_card_status": "PAN Card",
                            "vehicle_insurance_doc_status": "Vehicle Insurance"
                        };
                        ...
                        $.each(response.data.documents, function (key, doc) {
                            ...
                            const metaKey = key;
                            const label = labelMap[key] || metaKey.replace(/_/g, ' ');
