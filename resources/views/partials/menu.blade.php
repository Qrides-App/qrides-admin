            ...
            @can('booking_access')
                <li class="treeview {{ request()->is('admin/bookings*') || request()->is('admin/hire-bookings*') ? 'active menu-open' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ request()->is('admin/hire-bookings*') ? 'active' : '' }}">
                            <a href="{{ route('admin.hire-bookings.index') }}">
                                <i class="fas fa-dot-circle"></i>
                                <span>QR Hire Rides</span>
                            </a>
                        </li>
...
@endcan -->
                    ...
                    <li class="{{ request()->is('admin/recharge-plans') || request()->is('admin/recharge-plans/*') ? 'active' : '' }}">
                        <a href="{{ route('admin.recharge-plans.index') }}">
                            <i class="fas fa-dot-circle"></i>
                            <span>Driver Recharge Plans</span>
                        </a>
                    </li>
                </ul>
            </li>
