...
<body class="hold-transition login-page">
    @yield('content')
    <div style="text-align:center; margin: 12px 0 20px; color:#6b7280; font-size:12px; font-weight:600;">
        <div>QRIDES by BAMIRA TRANSPORTATION PRIVATE LIMITED</div>
        <div>
            <a href="https://rareus.in" target="_blank" style="color:#6b7280;">
                Designed, developed and maintained by Rareus Private Limited
            </a>
        </div>
    </div>
