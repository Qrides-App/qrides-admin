...
class AppUser extends Authenticatable implements HasMedia
{
    ...
    public function registerMediaCollections(): void
    {
        ...
        $this->addMediaCollection('driving_licence_front');
        $this->addMediaCollection('driving_licence_back');
        $this->addMediaCollection('aadhaar_front');
        $this->addMediaCollection('aadhaar_back');
        $this->addMediaCollection('pan_card');
        $this->addMediaCollection('vehicle_insurance_doc');
    }
