...
CMD ["/bin/sh", "-lc", "php artisan migrate --force --no-interaction || true; php artisan app:ensure-auth-schema --no-interaction || true; php artisan app:ensure-super-admin --no-interaction || true; apache2-foreground"]
